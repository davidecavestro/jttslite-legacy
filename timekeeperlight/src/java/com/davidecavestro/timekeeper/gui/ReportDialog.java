...
public class ReportDialog extends javax.swing.JDialog implements PersistentComponent, DialogNotifier {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(java.util.ResourceBundle.getBundle("com.davidecavestro.timekeeper.gui.res").getString("ReportsDialog/ActionGroup/ReportLaunchAction")));
        ...
        jRadioButton1.setText(java.util.ResourceBundle.getBundle("com/davidecavestro/timekeeper/gui/res").getString("ReportDialog/LaunchActionGroup/PreviewAction"));
        ...
        jRadioButton3.setText(java.util.ResourceBundle.getBundle("com/davidecavestro/timekeeper/gui/res").getString("ReportDialog/LaunchActionGroup/SaveAction"));
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(java.util.ResourceBundle.getBundle("com.davidecavestro.timekeeper.gui.res").getString("ReportDialog/ControlsGroup/ReportChoice")));
...
//		System.out.println ("extracting data from "+CalendarUtils.toTSString (startDate)+" for "+periodCount+" days");
		...
		if (jRadioButton1.isSelected ()) {
			...
			JOptionPane.showMessageDialog (_context.getWindowManager ().getMainWindow (), java.util.ResourceBundle.getBundle("com.davidecavestro.timekeeper.gui.res").getString("ReportExportMessageDialog/Exporting_completed"));
		}
