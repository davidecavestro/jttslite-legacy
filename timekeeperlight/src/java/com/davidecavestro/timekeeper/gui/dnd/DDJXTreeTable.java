...
/**
 * Questa classe è da considerarsi un componente in quanto estende 
 * JXTreeTable aggiungengo il supporto della funzionalità del Drag&Drop.
 * Tramite l'interfaccia IDragAndDrop è possibile gestire il comportamento
 * delle funzionalità di Drag&Drop.
		...
		class CDropTargetListener implements DropTargetListener
		{
			...
			public CDropTargetListener(DDJXTreeTable tree)
			{
				...
				*/
				 ...
				 * ramo dell'albero.
				 * Il tempo di espansione/collassamento del ramo è di un secondo.
				 * 
				 * @author Stefano
				 */
			...
			*/		
			public void dragOver(DropTargetDragEvent e)
			{
				...
				*/
				...
				//           appare un simbolo "divieto di accesso"....questo funzionamento è da testare
				//           con altre JVM
...
//			http://www.oreilly.com/catalog/jswing/chapter/dnd.beta.pdf
		...
		public void autoscroll(Point pt) 
		{
			...
			// è meglio esplicitare meglio l'IF per capire meglio il funzionamento
