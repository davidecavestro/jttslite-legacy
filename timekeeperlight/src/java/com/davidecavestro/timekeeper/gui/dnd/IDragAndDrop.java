...
public interface IDragAndDrop {
	...
	/**
	 * Metodo che controlla se un elemento può essere "DRAGGATO"
	 * 
	 * @param source
	 * @param target
	 * @return
	...
	/**
	 * Metodo che controlla se un elemento può essere "DROPPATO"
	 * 
	 * @param source
	 * @param target
	 * @return
	...
	/**
	 * E' richiamato per gestire la necessità di eseguire un refresh dei dati
	 *
	 */
