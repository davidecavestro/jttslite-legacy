...
package net.sf.jttslite.gui.charts;
...
public final class SerieNodeToolTipSupplier {
	...
	private final static class DefaultPolicy implements ToolTipGenerationPolicy {
		...
		public String generate (final SerieNode node){
			...
			.append ("<B>")
			.append (java.util.ResourceBundle.getBundle("net.sf.jttslite.gui.res").getString("RingChart/Tooltip/parent_percentage"))
			.append ("</B>")
			.append ("</TD>")
			.append ("</TR>")
			...
			.append ("<TD align=right>")
			.append ("<B>")
			.append (java.util.ResourceBundle.getBundle("net.sf.jttslite.gui.res").getString("RingChart/Tooltip/node_total_time"))
			.append ("</B>")
			.append (": ")
			.append ("</TD>")
