/*
 * PieceOfWorkTemplateModelEvent.java
 *
 * Created on August 2, 2008, 5:01 PM
 *
 */

package net.sf.jttslite.model.event;
 ...
 */
public class PieceOfWorkTemplateModelEvent extends EventObject {
	 ...
	 */
	public PieceOfWorkTemplateModelEvent (Object source, int type, int index0, int index1) {
		super (source);
		this.type = type;
