...
import net.sf.jttslite.gui.CustomizableFormat;
	...
	private final class TimeCumulationScale {
		...
		public TimeCumulationScale (final Date from, final Date to, final int step){
			...
			while (current.before (to)){
                 ...
                 * usando il calendar, in quanto non � sufficiente aggiungere il numero di millisecondi
                 *
                 * In pratica, al passaggio tra ora legale/solare e viceversa non � corretto aggiungere 24 ore, ma 23 o 25...
                 */
